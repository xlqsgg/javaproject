							...
							<div class="twitter-info-wrapper">
								<div class="single-twitter">
									...
									<div class="twitter-content">
										<p>A modern <a href="#">#Shopify theme </a> <a class="link1" href="#">@devitems</a> <br><a class="link2" href="#">https://twitter.</a></p>
									</div>
								</div>
								<div class="single-twitter">
									<div class="twitter-icon">
									...
									<div class="twitter-content">
										<p>A modern <a href="#">#Shopify theme </a> <a class="link1" href="#">@devitems</a> <br> <a class="link2" href="#">http://sc.chinaz.com</a></p>
									</div>
								</div>
								<div class="single-twitter">
									<div class="twitter-icon">
